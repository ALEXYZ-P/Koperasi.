                  ...
                  <tbody>
                    ...
                    <?php foreach ($user as $value): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-ref" href="<?php echo site_url('Member_controller/edit_data/'.$value->id_user) ?>"><i class="fa fa-fw fa-edit"></i> Edit</a>

                          <a onclick="deleteConfirm('<?php echo site_url('Member_controller/delete/'.$value->id_user) ?>')" href="#!" class="btn btn-danger" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i> Delete</a>
    
                          <a class="btn btn-warning" href="<?php echo site_url('Member_controller/detail/'.$value->id_user) ?>"><i class="fa fa-fw fa-users"></i>Detail</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
