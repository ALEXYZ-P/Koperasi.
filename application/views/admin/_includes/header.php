 <header class="main-header">
    ...
    <a class="logo"  onClick="document.location.reload(true)">
      ...
      <span class="logo-lg"><b>Cooperative </b>R</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assetAdmin/dist/img/pfp1.jpg'); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata('nama'); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('assetAdmin/dist/img/pfp1.jpg')?>" class="img-circle" alt="User sipo">
